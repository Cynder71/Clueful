...
class _LoginState extends State<LoginScreen> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text("Ocorreu um erro ao tentar entrar. Por favor, verifique suas credenciais e tente novamente."),
          actions: <Widget>[
            TextButton(
              child: const Text("OK"),
              onPressed: () {
  ...
  return TextButton(
      onPressed: () {
        // Substitua `SignUpScreen` pela tela que deseja navegar
        Navigator.push(
          context,
